        ...
        <section className="py-24 bg-gray-50 dark:bg-dark-900 transition-colors duration-300">
            <div className="container mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
                    {/* Card 1 */}
                    <div className="bg-white dark:bg-dark-800 p-6 md:p-8 lg:p-8 xl:p-10 rounded-[2rem] shadow-lg border border-gray-100 dark:border-white/5 hover:-translate-y-2 transition-transform duration-300 group">
                        ...
                        <h3 className="font-serif text-xl md:text-2xl lg:text-xl xl:text-2xl text-gray-900 dark:text-white mb-4">Emotional Intelligence</h3>
                        <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm md:text-base lg:text-sm xl:text-base">
                    ...
                    <div className="bg-white dark:bg-dark-800 p-6 md:p-8 lg:p-8 xl:p-10 rounded-[2rem] shadow-lg border border-gray-100 dark:border-white/5 hover:-translate-y-2 transition-transform duration-300 group">
                        ...
                        <h3 className="font-serif text-xl md:text-2xl lg:text-xl xl:text-2xl text-gray-900 dark:text-white mb-4">Heirloom Quality</h3>
                        <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm md:text-base lg:text-sm xl:text-base">
                    ...
                    {/* Card 3 */}
                    <div className="bg-white dark:bg-dark-800 p-6 md:p-8 lg:p-8 xl:p-10 rounded-[2rem] shadow-lg border border-gray-100 dark:border-white/5 hover:-translate-y-2 transition-transform duration-300 group md:col-span-2 lg:col-span-1">
                        <div className="w-14 h-14 bg-gray-100 dark:bg-white/5 rounded-2xl flex items-center justify-center text-gray-900 dark:text-white mb-6 group-hover:bg-gold-500 group-hover:text-black transition-colors">
                            <Clock size={28} />
                        </div>
                        <h3 className="font-serif text-xl md:text-2xl lg:text-xl xl:text-2xl text-gray-900 dark:text-white mb-4">Seamless Workflow</h3>
                        <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm md:text-base lg:text-sm xl:text-base">
