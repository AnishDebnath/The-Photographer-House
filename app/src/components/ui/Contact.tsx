    ...
    return (
        <section id="contact" className="py-24 bg-gray-50 dark:bg-dark-900 transition-colors duration-300" aria-labelledby="contact-heading">
            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-0 bg-[#1A1A1A] rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl">
                    {/* Map Side (Left) */}
                    <div className="relative min-h-[350px] md:min-h-full p-4 md:p-4 lg:p-6">
                        <div className="w-full h-full rounded-[1.5rem] md:rounded-[2rem] overflow-hidden relative min-h-[300px]">
                            <iframe
                    ...
                    {/* Text Side (Right) */}
                    <div className="p-6 md:p-8 lg:p-10 flex flex-col justify-center text-left">
